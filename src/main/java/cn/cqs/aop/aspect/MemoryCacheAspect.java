...
import cn.cqs.aop.utils.MemoryCacheManager;
...
public class MemoryCacheAspect{
    ...
    @Pointcut("execution(@cn.cqs.aop.annotation.MemoryCache * *(..))")//方法切入点
    ...
    public Object aroundJoinPoint(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        Log.d(TAG,"MemoryCache key：" + key + "--->" + (result != null ? "not null" : "null"));
        ...
        Log.d(TAG,"MemoryCache key：" + key + "--->" + "save");
        return result;
    }
}
